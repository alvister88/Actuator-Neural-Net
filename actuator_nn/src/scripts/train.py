...
def main():
    # Set paths
    model_path = '../weights/best_actuator_gru_model17.pt'
    train_data = '../data/gains2/train_data_2.txt'
    validation_data = '../data/gains2/validation_data_2.txt'
